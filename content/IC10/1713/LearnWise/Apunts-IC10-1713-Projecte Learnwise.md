...
Abans de començar a crear res, **hem de tenir clar què pensem que passarà**. Aquestes suposicions s’anomenen **hipòtesis** i són la base del mètode *Lean Startup*.
## Què cal tenir en compte per formular una hipòtesi?
### Simplicitat i claredat
Una hipòtesi ha de ser **curta i fàcil d’entendre**.
Exemple: *“Els alumnes voldran utilitzar una eina per recordar exàmens i tasques.”*
### Ser comprovable
Ha de poder-se verificar amb dades reals.
Exemple: *Mètrica clara: “Com a mínim 10 alumnes utilitzaran l’eina durant la primera setmana.”*
### Relacionada amb l’usuari
Les hipòtesis han de parlar del que **faran o voldran les persones que utilitzaran el producte**.
Exemple: *“Els professors trobaran útil tenir informes automàtics de seguiment.”*
### Quantificable
Afegir un número ajuda a **saber si la hipòtesi és certa o falsa**.
Exemple: *“El 50% dels alumnes que provin l’eina tornaran a utilitzar-la la setmana següent.”*
...
D'aquesta forma queda clar que s'ha de fer en aquesta sessió i si no s'acaba la tasca serà una *desviació* respecte al que heu planificat i caldrà veure entre tots el motiu: *¿Heu planificat malament? ¿Han sorgit imprevistos, quins? ¿No s'ha treballat prou avuí?*
