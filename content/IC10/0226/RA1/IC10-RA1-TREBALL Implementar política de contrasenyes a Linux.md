...
> auth required pam\_ faillock.so preauth audit deny=3 fail\_ interval=60 unlock\_ time=300

Abans de la línia `auth [success=1 default=ignore] pam_unix.so nullok`.

I també les línies:

> auth \[default=die] pam\_ faillock.so authfail audit deny=3 fail\_ interval=60 unlock\_ time=300
>
> auth sufficient pam\_ faillock.so authsucc audit deny=3 fail\_ interval=60 unlock\_ time=300
